...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar DEFAULT 'Brian Wells' NOT NULL,
  	"tagline" varchar,
  ...
  CREATE TABLE "skills_groups_items" (
  	"_order" integer NOT NULL,
  ...
  ALTER TABLE "skills_groups_items" ADD CONSTRAINT "skills_groups_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."skills_groups"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "skills_groups_items_order_idx" ON "skills_groups_items" USING btree ("_order");
  CREATE INDEX "skills_groups_items_parent_id_idx" ON "skills_groups_items" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "skills_groups_items" CASCADE;
